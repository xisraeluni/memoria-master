...
<head>
    ...
    <style type="text/css">
		...
		#fox_full_link {
			...
			max-height: 100%;
            background: transparent url('https://github.com/xisraeluni/images/<?= $random_fox_index ?>.jpg') 0 0/contain no-repeat;
			margin: 10px;
		}
        #fox_img_link {
            float: left;
...
<div id="panel">
	<div id="sidebar">
		...
		<input type="text" id="shareButton" value="https://memoria-master/?i=<?= $random_fox_index ?>" onclick="this.select();" /><br />
	...
	<a href="https://memoria-master/?i=<?= $random_fox_index ?>" id="fox_full_link">
		<img src="https://memoria-master/images/<?= $random_fox_index ?>.jpg" alt="" title="" style="visibility: hidden;" id="fox_img_link" />
	</a>
